...
<html lang="en">
  <head>
    ...
    <title>Sistema de movimiento de alumnos</title>
  ...
  <body class="app header-fixed sidebar-fixed aside-menu-fixed asside-menu-hidden sidebar-lg-show">
  <div id = "app">
    ...
    <footer class="app-footer">
      <div>
        <a href="https://coreui.io">LemaFred</a>
