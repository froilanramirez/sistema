                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div class="form-group row">
                                <label for="text-input" class="col-md-3 form-control-label">Contacto</label>
                                <div class="col-md-9">
                            ...
                            <div class="form-group row">
                                <label for="tel-input" class="col-md-3 form-control-label">Teléfono del contacto</label>
                                <div class="col-md-9">
