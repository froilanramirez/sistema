        ...
        <div class="container-fluid">
          <div class="card">
              ...
              <table class="table table-bordered table-striped table-sm">
                  ...
                  <tbody>
                      <tr v-for="categoria in arrarCategoria" :key="categoria.categoriasid">
                          <td>
                          ...
                          <td v-text="categoria.categoriasnombre"></td>
                          <td v-text="categoria.categoriasdescripcion"></td>
                          <td>
        ...
        methods:{
            listarCategoria(page,buscar,criterio){
                ...
                axios.get(url).then(function (response) {
                    ...
                    me.arrarCategoria = respuesta.categorias.data;
